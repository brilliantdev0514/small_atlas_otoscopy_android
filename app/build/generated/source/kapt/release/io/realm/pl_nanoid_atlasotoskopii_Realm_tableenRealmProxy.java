...
public class pl_nanoid_atlasotoskopii_Realm_tableenRealmProxy extends pl.nanoid.atlasotoskopii.Realm.tableen
    implements RealmObjectProxy, pl_nanoid_atlasotoskopii_Realm_tableenRealmProxyInterface {

    static final class tableenColumnInfo extends ColumnInfo {
        ...
        tableenColumnInfo(OsSchemaInfo schemaInfo) {
            super(7);
            OsObjectSchemaInfo objectSchemaInfo = schemaInfo.getObjectSchemaInfo("tableen");
        ...
        tableenColumnInfo(ColumnInfo src, boolean mutable) {
            super(src, mutable);
            copy(src, this);
        }
        ...
        protected final ColumnInfo copy(boolean mutable) {
            return new tableenColumnInfo(this, mutable);
        }

        @Override
        protected final void copy(ColumnInfo rawSrc, ColumnInfo rawDst) {
            final tableenColumnInfo src = (tableenColumnInfo) rawSrc;
            final tableenColumnInfo dst = (tableenColumnInfo) rawDst;
    ...
    private tableenColumnInfo columnInfo;
    private ProxyState<pl.nanoid.atlasotoskopii.Realm.tableen> proxyState;

    pl_nanoid_atlasotoskopii_Realm_tableenRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.columnInfo = (tableenColumnInfo) context.getColumnInfo();
        this.proxyState = new ProxyState<pl.nanoid.atlasotoskopii.Realm.tableen>(this);
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        OsObjectSchemaInfo.Builder builder = new OsObjectSchemaInfo.Builder("tableen", 7, 0);
    ...
    public static tableenColumnInfo createColumnInfo(OsSchemaInfo schemaInfo) {
        return new tableenColumnInfo(schemaInfo);
    }
    ...
    public static final class ClassNameHelper {
        public static final String INTERNAL_CLASS_NAME = "tableen";
    }

    @SuppressWarnings("cast")
    public static pl.nanoid.atlasotoskopii.Realm.tableen createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        pl.nanoid.atlasotoskopii.Realm.tableen obj = realm.createObjectInternal(pl.nanoid.atlasotoskopii.Realm.tableen.class, true, excludeFields);

        final pl_nanoid_atlasotoskopii_Realm_tableenRealmProxyInterface objProxy = (pl_nanoid_atlasotoskopii_Realm_tableenRealmProxyInterface) obj;
        if (json.has("dis_id")) {
    ...
    public static pl.nanoid.atlasotoskopii.Realm.tableen createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final pl.nanoid.atlasotoskopii.Realm.tableen obj = new pl.nanoid.atlasotoskopii.Realm.tableen();
        final pl_nanoid_atlasotoskopii_Realm_tableenRealmProxyInterface objProxy = (pl_nanoid_atlasotoskopii_Realm_tableenRealmProxyInterface) obj;
        reader.beginObject();
    ...
    private static pl_nanoid_atlasotoskopii_Realm_tableenRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating unexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(pl.nanoid.atlasotoskopii.Realm.tableen.class), false, Collections.<String>emptyList());
        io.realm.pl_nanoid_atlasotoskopii_Realm_tableenRealmProxy obj = new io.realm.pl_nanoid_atlasotoskopii_Realm_tableenRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static pl.nanoid.atlasotoskopii.Realm.tableen copyOrUpdate(Realm realm, tableenColumnInfo columnInfo, pl.nanoid.atlasotoskopii.Realm.tableen object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (pl.nanoid.atlasotoskopii.Realm.tableen) cachedRealmObject;
        }

        return copy(realm, columnInfo, object, update, cache, flags);
    }

    public static pl.nanoid.atlasotoskopii.Realm.tableen copy(Realm realm, tableenColumnInfo columnInfo, pl.nanoid.atlasotoskopii.Realm.tableen newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (pl.nanoid.atlasotoskopii.Realm.tableen) cachedRealmObject;
        }

        pl_nanoid_atlasotoskopii_Realm_tableenRealmProxyInterface realmObjectSource = (pl_nanoid_atlasotoskopii_Realm_tableenRealmProxyInterface) newObject;

        Table table = realm.getTable(pl.nanoid.atlasotoskopii.Realm.tableen.class);
        ...
        io.realm.pl_nanoid_atlasotoskopii_Realm_tableenRealmProxy realmObjectCopy = newProxyInstance(realm, row);
        cache.put(newObject, realmObjectCopy);

        return realmObjectCopy;
    }

    public static long insert(Realm realm, pl.nanoid.atlasotoskopii.Realm.tableen object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(pl.nanoid.atlasotoskopii.Realm.tableen.class);
        long tableNativePtr = table.getNativePtr();
        tableenColumnInfo columnInfo = (tableenColumnInfo) realm.getSchema().getColumnInfo(pl.nanoid.atlasotoskopii.Realm.tableen.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        Number realmGet$dis_id = ((pl_nanoid_atlasotoskopii_Realm_tableenRealmProxyInterface) object).realmGet$dis_id();
        ...
        String realmGet$dis_name = ((pl_nanoid_atlasotoskopii_Realm_tableenRealmProxyInterface) object).realmGet$dis_name();
        if (realmGet$dis_name != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.dis_nameIndex, rowIndex, realmGet$dis_name, false);
        }
        String realmGet$dis_description = ((pl_nanoid_atlasotoskopii_Realm_tableenRealmProxyInterface) object).realmGet$dis_description();
        ...
        String realmGet$dis_short_description = ((pl_nanoid_atlasotoskopii_Realm_tableenRealmProxyInterface) object).realmGet$dis_short_description();
        ...
        String realmGet$dis_treatment = ((pl_nanoid_atlasotoskopii_Realm_tableenRealmProxyInterface) object).realmGet$dis_treatment();
        ...
        String realmGet$dis_img_description = ((pl_nanoid_atlasotoskopii_Realm_tableenRealmProxyInterface) object).realmGet$dis_img_description();
        ...
        String realmGet$dis_proposed_treatment = ((pl_nanoid_atlasotoskopii_Realm_tableenRealmProxyInterface) object).realmGet$dis_proposed_treatment();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        tableenColumnInfo columnInfo = (tableenColumnInfo) realm.getSchema().getColumnInfo(pl.nanoid.atlasotoskopii.Realm.tableen.class);
        pl.nanoid.atlasotoskopii.Realm.tableen object = null;
        while (objects.hasNext()) {
            object = (pl.nanoid.atlasotoskopii.Realm.tableen) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, pl.nanoid.atlasotoskopii.Realm.tableen object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(pl.nanoid.atlasotoskopii.Realm.tableen.class);
    ...
    public static pl.nanoid.atlasotoskopii.Realm.tableen createDetachedCopy(pl.nanoid.atlasotoskopii.Realm.tableen realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        pl.nanoid.atlasotoskopii.Realm.tableen unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new pl.nanoid.atlasotoskopii.Realm.tableen();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (pl.nanoid.atlasotoskopii.Realm.tableen) cachedObject.object;
            }
            unmanagedObject = (pl.nanoid.atlasotoskopii.Realm.tableen) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        pl_nanoid_atlasotoskopii_Realm_tableenRealmProxyInterface unmanagedCopy = (pl_nanoid_atlasotoskopii_Realm_tableenRealmProxyInterface) unmanagedObject;
        pl_nanoid_atlasotoskopii_Realm_tableenRealmProxyInterface realmSource = (pl_nanoid_atlasotoskopii_Realm_tableenRealmProxyInterface) realmObject;
    ...
    public String toString() {
        ...
        StringBuilder stringBuilder = new StringBuilder("tableen = proxy[");
    ...
    public boolean equals(Object o) {
        ...
        pl_nanoid_atlasotoskopii_Realm_tableenRealmProxy atableen = (pl_nanoid_atlasotoskopii_Realm_tableenRealmProxy)o;

        String path = proxyState.getRealm$realm().getPath();
        String otherPath = atableen.proxyState.getRealm$realm().getPath();
        if (path != null ? !path.equals(otherPath) : otherPath != null) return false;

        String tableName = proxyState.getRow$realm().getTable().getName();
        String otherTableName = atableen.proxyState.getRow$realm().getTable().getName();
        if (tableName != null ? !tableName.equals(otherTableName) : otherTableName != null) return false;

        if (proxyState.getRow$realm().getIndex() != atableen.proxyState.getRow$realm().getIndex()) return false;
