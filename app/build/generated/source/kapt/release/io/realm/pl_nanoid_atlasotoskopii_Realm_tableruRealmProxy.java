...
public class pl_nanoid_atlasotoskopii_Realm_tableruRealmProxy extends pl.nanoid.atlasotoskopii.Realm.tableru
    implements RealmObjectProxy, pl_nanoid_atlasotoskopii_Realm_tableruRealmProxyInterface {

    static final class tableruColumnInfo extends ColumnInfo {
        ...
        tableruColumnInfo(OsSchemaInfo schemaInfo) {
            super(7);
            OsObjectSchemaInfo objectSchemaInfo = schemaInfo.getObjectSchemaInfo("tableru");
        ...
        tableruColumnInfo(ColumnInfo src, boolean mutable) {
            super(src, mutable);
            copy(src, this);
        }
        ...
        protected final ColumnInfo copy(boolean mutable) {
            return new tableruColumnInfo(this, mutable);
        }

        @Override
        protected final void copy(ColumnInfo rawSrc, ColumnInfo rawDst) {
            final tableruColumnInfo src = (tableruColumnInfo) rawSrc;
            final tableruColumnInfo dst = (tableruColumnInfo) rawDst;
    ...
    private tableruColumnInfo columnInfo;
    private ProxyState<pl.nanoid.atlasotoskopii.Realm.tableru> proxyState;

    pl_nanoid_atlasotoskopii_Realm_tableruRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.columnInfo = (tableruColumnInfo) context.getColumnInfo();
        this.proxyState = new ProxyState<pl.nanoid.atlasotoskopii.Realm.tableru>(this);
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        OsObjectSchemaInfo.Builder builder = new OsObjectSchemaInfo.Builder("tableru", 7, 0);
    ...
    public static tableruColumnInfo createColumnInfo(OsSchemaInfo schemaInfo) {
        return new tableruColumnInfo(schemaInfo);
    }
    ...
    public static final class ClassNameHelper {
        public static final String INTERNAL_CLASS_NAME = "tableru";
    }

    @SuppressWarnings("cast")
    public static pl.nanoid.atlasotoskopii.Realm.tableru createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        pl.nanoid.atlasotoskopii.Realm.tableru obj = realm.createObjectInternal(pl.nanoid.atlasotoskopii.Realm.tableru.class, true, excludeFields);

        final pl_nanoid_atlasotoskopii_Realm_tableruRealmProxyInterface objProxy = (pl_nanoid_atlasotoskopii_Realm_tableruRealmProxyInterface) obj;
        if (json.has("dis_id")) {
    ...
    public static pl.nanoid.atlasotoskopii.Realm.tableru createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final pl.nanoid.atlasotoskopii.Realm.tableru obj = new pl.nanoid.atlasotoskopii.Realm.tableru();
        final pl_nanoid_atlasotoskopii_Realm_tableruRealmProxyInterface objProxy = (pl_nanoid_atlasotoskopii_Realm_tableruRealmProxyInterface) obj;
        reader.beginObject();
    ...
    private static pl_nanoid_atlasotoskopii_Realm_tableruRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating unexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(pl.nanoid.atlasotoskopii.Realm.tableru.class), false, Collections.<String>emptyList());
        io.realm.pl_nanoid_atlasotoskopii_Realm_tableruRealmProxy obj = new io.realm.pl_nanoid_atlasotoskopii_Realm_tableruRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static pl.nanoid.atlasotoskopii.Realm.tableru copyOrUpdate(Realm realm, tableruColumnInfo columnInfo, pl.nanoid.atlasotoskopii.Realm.tableru object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (pl.nanoid.atlasotoskopii.Realm.tableru) cachedRealmObject;
        }

        return copy(realm, columnInfo, object, update, cache, flags);
    }

    public static pl.nanoid.atlasotoskopii.Realm.tableru copy(Realm realm, tableruColumnInfo columnInfo, pl.nanoid.atlasotoskopii.Realm.tableru newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (pl.nanoid.atlasotoskopii.Realm.tableru) cachedRealmObject;
        }

        pl_nanoid_atlasotoskopii_Realm_tableruRealmProxyInterface realmObjectSource = (pl_nanoid_atlasotoskopii_Realm_tableruRealmProxyInterface) newObject;

        Table table = realm.getTable(pl.nanoid.atlasotoskopii.Realm.tableru.class);
        ...
        io.realm.pl_nanoid_atlasotoskopii_Realm_tableruRealmProxy realmObjectCopy = newProxyInstance(realm, row);
        cache.put(newObject, realmObjectCopy);

        return realmObjectCopy;
    }

    public static long insert(Realm realm, pl.nanoid.atlasotoskopii.Realm.tableru object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(pl.nanoid.atlasotoskopii.Realm.tableru.class);
        long tableNativePtr = table.getNativePtr();
        tableruColumnInfo columnInfo = (tableruColumnInfo) realm.getSchema().getColumnInfo(pl.nanoid.atlasotoskopii.Realm.tableru.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        Number realmGet$dis_id = ((pl_nanoid_atlasotoskopii_Realm_tableruRealmProxyInterface) object).realmGet$dis_id();
        ...
        String realmGet$dis_name = ((pl_nanoid_atlasotoskopii_Realm_tableruRealmProxyInterface) object).realmGet$dis_name();
        if (realmGet$dis_name != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.dis_nameIndex, rowIndex, realmGet$dis_name, false);
        }
        String realmGet$dis_description = ((pl_nanoid_atlasotoskopii_Realm_tableruRealmProxyInterface) object).realmGet$dis_description();
        ...
        String realmGet$dis_short_description = ((pl_nanoid_atlasotoskopii_Realm_tableruRealmProxyInterface) object).realmGet$dis_short_description();
        ...
        String realmGet$dis_treatment = ((pl_nanoid_atlasotoskopii_Realm_tableruRealmProxyInterface) object).realmGet$dis_treatment();
        ...
        String realmGet$dis_img_description = ((pl_nanoid_atlasotoskopii_Realm_tableruRealmProxyInterface) object).realmGet$dis_img_description();
        ...
        String realmGet$dis_proposed_treatment = ((pl_nanoid_atlasotoskopii_Realm_tableruRealmProxyInterface) object).realmGet$dis_proposed_treatment();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        tableruColumnInfo columnInfo = (tableruColumnInfo) realm.getSchema().getColumnInfo(pl.nanoid.atlasotoskopii.Realm.tableru.class);
        pl.nanoid.atlasotoskopii.Realm.tableru object = null;
        while (objects.hasNext()) {
            object = (pl.nanoid.atlasotoskopii.Realm.tableru) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, pl.nanoid.atlasotoskopii.Realm.tableru object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(pl.nanoid.atlasotoskopii.Realm.tableru.class);
    ...
    public static pl.nanoid.atlasotoskopii.Realm.tableru createDetachedCopy(pl.nanoid.atlasotoskopii.Realm.tableru realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        pl.nanoid.atlasotoskopii.Realm.tableru unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new pl.nanoid.atlasotoskopii.Realm.tableru();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (pl.nanoid.atlasotoskopii.Realm.tableru) cachedObject.object;
            }
            unmanagedObject = (pl.nanoid.atlasotoskopii.Realm.tableru) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        pl_nanoid_atlasotoskopii_Realm_tableruRealmProxyInterface unmanagedCopy = (pl_nanoid_atlasotoskopii_Realm_tableruRealmProxyInterface) unmanagedObject;
        pl_nanoid_atlasotoskopii_Realm_tableruRealmProxyInterface realmSource = (pl_nanoid_atlasotoskopii_Realm_tableruRealmProxyInterface) realmObject;
    ...
    public String toString() {
        ...
        StringBuilder stringBuilder = new StringBuilder("tableru = proxy[");
    ...
    public boolean equals(Object o) {
        ...
        pl_nanoid_atlasotoskopii_Realm_tableruRealmProxy atableru = (pl_nanoid_atlasotoskopii_Realm_tableruRealmProxy)o;

        String path = proxyState.getRealm$realm().getPath();
        String otherPath = atableru.proxyState.getRealm$realm().getPath();
        if (path != null ? !path.equals(otherPath) : otherPath != null) return false;

        String tableName = proxyState.getRow$realm().getTable().getName();
        String otherTableName = atableru.proxyState.getRow$realm().getTable().getName();
        if (tableName != null ? !tableName.equals(otherTableName) : otherTableName != null) return false;

        if (proxyState.getRow$realm().getIndex() != atableru.proxyState.getRow$realm().getIndex()) return false;
